...
export default class ApiService {
    ...
    /**PAYMENT */
    /* This processes payment for a booking */
    static async processPayment(bookingId, amount) {
        const result = await axios.post(`${this.BASE_URL}/payments/process/${bookingId}`, 
            { amount: amount }, 
            {
                headers: this.getHeader()
            }
    ...
    /* This gets payment by booking ID */
    static async getPaymentByBookingId(bookingId) {
        const result = await axios.get(`${this.BASE_URL}/payments/booking/${bookingId}`, {
            headers: this.getHeader()
        })
        return result.data
    }
    ...
    /**ADMIN DASHBOARD */
    /* This gets dashboard statistics */
    static async getDashboardStatistics() {
        const result = await axios.get(`${this.BASE_URL}/admin/dashboard/statistics`, {
            headers: this.getHeader()
        })
        return result.data
    }
